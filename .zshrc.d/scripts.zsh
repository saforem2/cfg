...
githeat() {
    tfp=$DOTFILES/bash/scripts/heatmap.sh
    test -e $tfp && ./${tfp}
}

colorblocks() {
    tfp=$DOTFILES/bash/scripts/colorblocks.sh
    test -e $tfp && ./${tfp}
}

colorcards() {
    tfp=$DOTFILES/bash/scripts/colorcards.sh
    test -e $tfp && ./${tfp}
}

colors() {
    tfp=$DOTFILES/bash/scripts/colors.sh
    test -e $tfp && ./${tfp}
    test -e $tfp && ./${tfp}
}

pipes() {
    $tfp=DOTFILES/bash/scripts/pipes.sh
    test -e $tfp && ./${tfp}
}

smedia() {
    tfp=$DOTFILES/bash/scripts/smedia.sh $@
    test -e $tfp && ./${tfp}
}
